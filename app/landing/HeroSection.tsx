...
export function Hero(){
    return(<>                     
        <div className="flex w-full h-screen pb-xl pt-sm relative max-h-[800px] min-h-[700px] ">
           {/* <div className="relative "> */}
                <div className=" flex flex-col  justify-between  ">
                                <Navbar/>
                            <div className="min-md:max-w-[510px] max-lg:w-[780px]">
           ...
           {/* </div> */}
            <div className="relative flex justify-end items-center w-full h-full  max-lg:hidden  ">
                <div className=" w-100  max-md:hidden relative h-full flex items-center flex-col justify-end pl-xl pb-xl bg-[#E2E5FF] ">
